...
import {Home, Trophy, User, LogIn, Zap,LogOut} from 'lucide-react'
  ...
  return (
    <div className='w-full flex justify-center py-6 font-display'>
        <nav className='flex items-center gap-2 rounded-xl px-5 py-2'>
            ...
            <div className='h-6 w-0.5 bg-gray-700 mx-2'></div>

            {user ? (
              <div className="flex items-center gap-3">
              <span className="text-gray-800 font-medium px-2 py-1.5">
               Hi, {user.userName}
              </span>
              ...
              title='LogOut'
              onClick={logout}
              className=" font-bold px-3 py-2 text-m rounded-md bg-red-200 hover:bg-red-300"
            >
